...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			std::cout << "        Global memory size: " << globalMemorySize / 1024 / 1024 << " MB" << std::endl;

			cl_bool hasUnifiedMemory;
			OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_HOST_UNIFIED_MEMORY, sizeof(cl_bool), &hasUnifiedMemory, nullptr));
			std::cout << "        Host unified memory: " << (hasUnifiedMemory ? "yep" : "no(") << std::endl;
			...
			std::cout << "        Local memory size: " << localMemorySize / 1024 << " KB" << std::endl;
